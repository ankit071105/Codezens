...
import StyledButton from "@/components/ui/StyledButton"; // Import styled button
  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white flex flex-col animate-gradient">
      ...
      <div className="flex justify-between items-center p-6">
        <h1 className="text-4xl border-b border-blue-500 font-mono text-blue-300">
          The WorkHub
        </h1>

        {/* Changed Code */}
        <StyledButton onClick={createWorkspace} disabled={isCreating}>
          {isCreating ? (
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="bg-[#1E293B] text-white">
          ...
          {/* ✅ Only plain text inside DialogDescription */}
          <DialogDescription>
            Enter the name of the workspace and select if it should be
            public/private.
          </DialogDescription>

          {/* ✅ Move other elements outside */}
          <Input
